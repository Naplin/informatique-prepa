...
def est_accessible_efficace(g, x, y):
    n = len(g)
    t = [False] * n
...
entree = 0
sortie = len(labyrinthe_lst) - 1
monstre = 666
tresor = 777
#print(sortie)
#print('La sortie est accessible :' + str(est_accessible(labyrinthe_lst, entree, sortie)))
#print('Le monstre est accessible :' + str(est_accessible(labyrinthe_lst, entree, monstre)))
#print('Le tresor est accessible :' + str(est_accessible(labyrinthe_lst, entree, tresor)))
